...
struct FrameQualityAnalyzer {
    ...
    struct Thresholds {
        static let sharpness: CGFloat = 100
        static let glare: CGFloat = 0.3
        static let motionBlur: CGFloat = 0.5
    }
    ...
    struct AnalysisResult {
        ...
        let glareLevel: Double
        let motionScore: Double
        let overallScore: Double
        let isAcceptable: Bool
        let warnings: [QualityWarning]
        
        enum QualityWarning: String {
    ...
    func analyze(_ uiImage: UIImage) -> AnalysisResult {
...
extension FrameQualityAnalyzer.AnalysisResult {
    ...
    var feedbackMessage: String {
        ...
        let messages = warnings.map { $0.rawValue }
