...
final class TelemetryStorage {
    ...
    func save(_ record: TelemetryRecord) {
    ...
    func pendingRecords() -> [TelemetryRecord] {
        persistence.load() ?? []
    }
    ...
    func markAsUploaded(_ records: [TelemetryRecord]) {
    ...
    /// Remove old records
    func removeOldRecords(olderThan date: Date) {
